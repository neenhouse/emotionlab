    ...
    <>
      ...
      <header className="header">
        <div className="header__inner container">
          <button className="header__logo" onClick={() => onNavigate('home')} aria-label="EmotionLab — go to home">
            <svg className="header__logo-icon" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <defs>
